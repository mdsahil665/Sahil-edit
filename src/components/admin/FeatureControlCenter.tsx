...
interface FeatureItem {
  ...
  label: string;
  description: string;
  category: 'GENERAL' | 'SOCIAL MEDIA' | 'POST FEATURES' | 'MONETIZATION' | 'SEO' | 'SECURITY' | 'ADVANCED';
}
...
export const FeatureControlCenter: React.FC<FeatureControlCenterProps> = ({ featureControls }) => {
  ...
  const categories = ['ALL', 'GENERAL', 'POST FEATURES', 'MONETIZATION', 'SEO', 'SECURITY', 'ADVANCED'];
